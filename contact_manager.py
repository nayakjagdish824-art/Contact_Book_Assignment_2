...
# Description:
# This Contact Book is a Python-based file handling project.
...
# - Import and display data from JSON
#
# It uses:
# - CSV file for storing contacts
# - JSON file for exporting/importing contacts
# - Error logging (error_log.txt) with timestamps
#
